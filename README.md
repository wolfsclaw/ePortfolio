...
<p align="center" style="color:#000;">
  <strong>Clean UI. Cloud‑connected systems. Production‑ready code.</strong>
</p>
...
- Present design proposals and justify architectural decisions  
- Document work clearly for future developers  
...
I learned how to evaluate efficiency, reason about performance, and choose appropriate structures for real‑world problems.

### 🧩 Software Engineering  
I learned how to design modular, maintainable, testable systems using industry best practices.

### 🗄️ Databases & Cloud Integration  
...
## 🚀 Professional Growth & Employability

Developing this ePortfolio helped me:

- Showcase my technical strengths  
- Demonstrate my ability to enhance existing systems  
- Communicate design decisions clearly  
- Present myself as industry‑ready  

<hr style="border: 1px solid #003366;">

## 📁 How My Artifacts Fit Together

- **Software Engineering Artifact** — mobile development, UI/UX, cloud integration  
- **Algorithm Artifact** — efficient, testable logic  
- **Database Artifact** — secure Firestore integration  

<hr style="border: 1px solid #003366;">

# 🔥 Featured Project — CS‑499 Capstone

### Mobile Inventory Management System (Flutter + Firebase)

**Tech Stack:** Flutter • Dart • Firebase • Firestore  
**Focus Areas:** UI/UX • Cloud Integration • Architecture • Testing
...
🔗 **[Code Review](https://1drv.ms/v/c/6d71f5f9c1c4e1a8/IQDn9KafHCBCSqYgfV0gL2oEAXBadB9cs7WD8R-xQS88gLM?e=hpSivk)**
